...
export default function AdminContextProvider({ children }) {
  ...
  const prepareOrder = order?.map((el) => {
    ...
    obj.address =
      el.address.address + " " + el.address.district + " " + el.address.province + " " + el.address.postcode;
    obj.price = price;
    obj.image = el.image;
  ...
  return (
    <AdminContext.Provider value={{ prepareOrder, handlePending, handSuccess, handFailed }}>
      {children}
